    ...
    */
    ...
    if (race==1) {
        for (i=0; i<6; i++) {
            ...
            var resultPush = "<b>" + rollTotal.toString() + "</b> (" + roll1.toString() + " + " + roll2.toString() + " + "  + roll3.toString() + ")";
        ...
        document.getElementById("additionalRule").innerHTML = "You may swap scores twice.";
    }
    if (race==2) {
        for (i=0; i<4; i++) {
            var roll1=Math.floor(Math.random()*6)+1;
            ...
            var resultPush = "<b>" + rollTotal.toString() + "</b> (" + roll1.toString() + " + " + roll2.toString() + " + 3)";
            statArray.push(resultPush);
        }
        document.getElementById("strScore").innerHTML = "<b>13</b>";
        document.getElementById("dexScore").innerHTML = statArray[0];
        document.getElementById("conScore").innerHTML = "<b>13</b>";
    ...
    if (race==3) {
        ...
        document.getElementById("strScore").innerHTML = statArray[0];
        document.getElementById("dexScore").innerHTML = "<b>13</b>";
        document.getElementById("conScore").innerHTML = statArray[1];
        document.getElementById("intScore").innerHTML = "<b>13</b>";
        document.getElementById("wisScore").innerHTML = statArray[2];
        document.getElementById("chaScore").innerHTML = statArray[3];
    ...
    if (race==4) {
        ...
        document.getElementById("conScore").innerHTML = statArray[2];
        document.getElementById("intScore").innerHTML = statArray[3];
        document.getElementById("wisScore").innerHTML = "<b>13</b>";
        document.getElementById("chaScore").innerHTML = "<b>13</b>";
